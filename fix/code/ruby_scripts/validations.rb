...
def is_valid_ip?(ip)
  ...
  if [
      ...
      "100.64.0.0", "127.0.0.0", "169.254.0.0", "192.0.0.0",
      "192.0.2.0", "192.88.99.0", "198.18.0.0", "198.51.100.0",
      "203.0.113.0", "224.0.0.0", "240.0.0.0"
    ].include?(ip)
  ...
  if [
      "255.255.255.255","10.255.255.255","172.31.255.255",
      "192.168.255.255", "100.127.255.255", "127.255.255.255",
      "169.254.255.255", "192.0.0.255", "192.0.2.255",
      "192.88.99.255", "198.19.255.255", "198.51.100.255",
      "203.0.113.255", "239.255.255.255", "255.255.255.254"
    ].include?(ip)
